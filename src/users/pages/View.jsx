      ...
      <div className="shadow border p-5 border-gray-200">
          <div className="md:grid grid-cols-4 gap-x-10">
            ...
            <div className="col-span-1">
              <img className='w-full' src="https://cdn11.bigcommerce.com/s-65f8qukrjx/images/stencil/500x659/products/6929/17271/Weir_Project_Hail_Mary_cover__95757.1680721262.jpg?c=1" alt="book" />
            </div>
            {/* book details column */}
              ...
              <div className="bg-white rounded-2xl md:w-250 w-100">
                ...
                <div className="realtive p-5">
                  ...
                  <div className="md:flex flex-wrap my-4 ">
                    <img className='md:w-75 w-25 md:me-2 mb-3 md:mb-0 ' src="https://cdn11.bigcommerce.com/s-65f8qukrjx/images/stencil/500x659/products/6929/17271/Weir_Project_Hail_Mary_cover__95757.1680721262.jpg?c=1" alt="book" />
                  </div>
                </div>
              </div>
          </div>
